...
export const aiProvidersModalTemplate = html`
<div id="ai-providers-modal" class="project-settings-modal" hidden aria-hidden="true">
    <div class="project-settings-modal-backdrop" aria-hidden="true"></div>
    <div class="project-settings-modal-dialog bevel-raised aip-modal-dialog" role="dialog" aria-modal="true" aria-labelledby="ai-providers-modal-title">

      <div class="project-settings-modal-header panel-header">
        <span id="ai-providers-modal-title"><i class="fa-solid fa-key" aria-hidden="true"></i> AI Settings</span>
        <button type="button" class="toolbar-btn project-settings-modal-close" data-cg-close="ai-providers-modal" aria-label="Close AI Providers &amp; Models">
