...
const WORKSPACE_ACTIONS: Record<string, string> = {
  ...
  'refresh-breakdown-from-script': 'refreshBreakdownFromScript',
  ...
  'add-storyboard-slate': 'addStoryboardSlateFrame',
  'upload-storyboard-image': 'uploadStoryboardFrameImage',
